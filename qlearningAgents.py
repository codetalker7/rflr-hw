...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        # used the in-built 'Counter': basically acts like a dictionary, with default value inialization of zero, for each unspecified key
    ...
    def getQValue(self, state, action):
        ...
        """
        # get the Q-values from q_values attribute
    ...
    def computeValueFromQValues(self, state):
        ...
        # use the in-built argMax method in 'Counter' class
        # returns max action for the given 'state' based on their Q-values
    ...
    def getAction(self, state):
        ...
        # if is_eplore = True, explore!
        if is_explore:
            # return a random legal action
            return random.choice(legalActions)
        else:
            # choose the action w.r.t. the policy
